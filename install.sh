...
PLIST_NAME="io.github.techymt.micpause.plist"
...
launchctl bootout "gui/$UID_NUM/io.github.techymt.micpause" 2>/dev/null || true
launchctl bootstrap "gui/$UID_NUM" "$PLIST_DEST"
launchctl enable "gui/$UID_NUM/io.github.techymt.micpause" || true
launchctl kickstart -k "gui/$UID_NUM/io.github.techymt.micpause"
...
echo
echo "To uninstall:"
echo "  launchctl bootout gui/$UID_NUM/io.github.techymt.micpause"
